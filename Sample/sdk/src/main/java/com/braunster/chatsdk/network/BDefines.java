...
public class BDefines {
    ...
    public static String ServerUrl = "https://facerecognitionchat-df0aa.firebaseio.com/" + BRootPath;

    /** The url that is used for the file uploads.*/
    public static String FirebaseStoragePath = "gs://facerecognitionchat-df0aa.appspot.com/";
